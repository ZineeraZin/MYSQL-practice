...
ALTER TABLE employees
ADD COLUMN employee_age int, add column employee_salary decimal(10,2);

INSERT INTO employees
(employee_id, employee_name, gender, age, hire_date, designation,
 department_id, location_id, employee_salary)
VALUES
...
SELECT*FROM employees
WHERE employee_salary >50000 AND hire_date < '2016-01-01';
...
SELECT SUM(e.employee_salary) AS Total_Salary
FROM employees e
JOIN departments d
...
SELECT l.location_name,
       MAX(e.employee_salary) AS Maximum_Salary
FROM employees e
JOIN location l
